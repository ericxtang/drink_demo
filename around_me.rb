...
get '/basketball' do
  ...
  @tags = ["basketball"]
  response = HTTParty.get("https://api.hyperpublic.com/api/v1/people?client_id=#{@client_id}&client_secret=#{@client_secret}&address=#{CGI::escape(@address)}&q=#{@tags.join(" ")}&limit=11")
